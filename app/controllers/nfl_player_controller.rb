...
class NflPlayerController < ApplicationController
  ...
  def validate_id_info(_player, _message)
  ...
  def find_and_update_player(_player, _message)
    # id_info = player['id_info']
  ...
  def find_player(_id_info, _message)
    # id = id_info['id']
    # if id
    #   begin
  ...
  def find_player_by_attributes(_id_info, _message)
    # name = id_info['name']
    # team = id_info['team']
    # type = id_info['type']
    ...
    # if team
    #   players = players.select do |_nfl_player|

    #   end
    # end
  end

  def update_player(_player, _player_model, _message)
  end

  def check_attributes(_id_info, _player_model, _message)
  end
end
